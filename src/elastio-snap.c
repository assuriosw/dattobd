...
blk_qc_t (*elastio_blk_mq_submit_bio)(struct bio *) = BLK_MQ_SUBMIT_BIO_ADDR != 0 ? (blk_qc_t (*)(struct bio *)) (BLK_MQ_SUBMIT_BIO_ADDR + (long long)(((void *)printk) - (void *)PRINTK_ADDR)) : 0;
#endif
